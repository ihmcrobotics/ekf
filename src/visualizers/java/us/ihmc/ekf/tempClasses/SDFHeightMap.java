...
import us.ihmc.ekf.tempClasses.SDFGeometry.HeightMap;
...
public class SDFHeightMap implements us.ihmc.graphicsDescription.HeightMap
{
   ...
   public double heightAt(double x, double y, double z)
   {
      ...
      int xPoint = (int) Math.round(xFactor * (width));
      int yPoint = (int) Math.round(yFactor * (height));
