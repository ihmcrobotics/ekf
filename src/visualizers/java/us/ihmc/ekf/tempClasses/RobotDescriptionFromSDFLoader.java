...
import us.ihmc.ekf.tempClasses.SDFSensor.IMU.IMUNoise.NoiseParameters;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray.Noise;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray.Range;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray.Scan;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray.Scan.HorizontalScan;
import us.ihmc.ekf.tempClasses.SDFSensor.Ray.Scan.VerticalScan;
...
public class RobotDescriptionFromSDFLoader
{
                                                       ...
                                                       ContactPointDefinitionHolder contactPointHolder, boolean useCollisionMeshes, double transparency)
   {
      ...
      if (jointNameMap != null && !Precision.equals(jointNameMap.getModelScale(), 1.0, 1))
      {
         ...
         robotDescription.scale(jointNameMap.getModelScale(),
                                jointNameMap.getMassScalePower(),
   ...
   private void addGroundContactPoints(ContactPointDefinitionHolder contactPointHolder)
   {
      ...
      for (ImmutablePair<String, Vector3D> jointContactPoint : contactPointHolder.getJointNameGroundContactPointMap())
      {
         ...
         GroundContactPointDescription groundContactPoint = new GroundContactPointDescription("gc_"
               + ModelFileLoaderConversionsHelper.sanitizeJointName(jointName) + "_" + count++,
                                                                                              gcOffset,
