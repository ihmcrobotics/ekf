...
{
   public static final double linearAccelerationSensorCovariance = 0.01;
   public static final double angularVelocitySensorCovariance = 0.01;
   public static final double jointPositionSensorCovariance = 0.0001;
